...
*   `views/`: Diretório que hospeda a lógica de apresentação e os controladores para diferentes interfaces.
    ...
    *   **`views/report_executivo.py`:** Um novo módulo que implementa a interface Streamlit para a geração e visualização do Report Executivo, permitindo ao usuário interagir com a análise da IA e baixar o relatório em PDF.
